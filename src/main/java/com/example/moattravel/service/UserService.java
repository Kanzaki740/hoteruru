...
public class UserService {
	...
	public User create(SignupForm signupForm) {
		...
		user.setPassword(passwordEncoder.encode(signupForm.getPassword())); //パスワードはハッシュ化してDB
		user.setRole(role);
		user.setEnabled(false); //24章true→false
	...
	public boolean isEmailRegistered(String email) {
		...
		return user != null; //userがnullでなければtrueを返す
	}
